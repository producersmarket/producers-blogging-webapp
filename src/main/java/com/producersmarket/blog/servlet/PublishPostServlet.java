...
*/
//public class PublishPostServlet extends ParentServlet {
public class PublishPostServlet extends BlogPostServlet {
        ...
        try {
            ...
            if(blogToken != null && blogToken.length() > 0) {
                ...
                try {
                    ...
                    this.executor.execute(new PublishBlogPostRequest(request.startAsync(), blogPostId));
    ...
    public class PublishBlogPostRequest implements Runnable {
        ...
        public PublishBlogPostRequest(
          ...
          , int blogPostId
            ...
            logger.debug(new StringBuilder().append("PublishBlogPostRequest(asyncContext").append(", '").append(blogPostId).append("')").toString());
    ...
    public void publishBlogPost(
      ...
      , int blogPostId
        ...
        logger.debug("publishBlogPost(request, response, "+blogPostId+")");

        try {

            BlogPostDatabaseManager.updateBlogPostEnabled(blogPostId, getConnectionManager());
